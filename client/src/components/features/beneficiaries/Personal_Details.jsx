...
const PersonalDetailsTable = () => {
  ...
  const handleDeleteConfirm = async (beneficiary) => {
    try {
      ...
      await fetchBeneficiaries();
      // Show success notification while keeping delete modal open
      ...
      setAlertModal(getAlertConfig('error', 'Failed', errorData.message || 'Failed to delete beneficiary. Please try again.'));
    }
  };
